...
class UserInterface:
    ...
    def __init__(self, game_manager: GameManager):
        ...
        # Get this num for the first round. When going to the next stage, it gets another random number.
        ...
        while is_game_on:
            ...
            if self.game.ph_level <= 0:
                ...
                is_game_on = False
                self.game_over()
            elif self.game.is_next_stage():
                # Next stage when there isn't any rain left.
                self.next_stage()

            # Clear bottom_status_canvas after certain time if needed.
    ...
    def create_rain(self):
        ...
        rain.raw_turtle.write(rain.word, align="center", font=RAIN_FONT_STYLE)
    ...
    def next_stage(self):
        ...
        self.game.rain_move_distance += 2  # Make rain moves faster!
        # Pop-up Message
    ...
    def remove_all_rain_on_the_screen(self):
        ...
        self.bottom_status_canvas.itemconfig(self.special_effect_description_text,
                                             text="Removed all rain on the screen.")
