...
WORDS_STARTING_LEFT_COORDINATE = SCREEN_LEFT + 50
WORDS_STARTING_RIGHT_COORDINATE = SCREEN_RIGHT - 50
...
class WordManager:
    ...
    def create_word(self):
        ...
        t.hideturtle()
        t.penup()
        random_x = random.randint(WORDS_STARTING_LEFT_COORDINATE, WORDS_STARTING_RIGHT_COORDINATE)
        t.goto(random_x, WORDS_STARTING_LINE_Y_COR)
        t.setheading(DIRECTION_DOWN)
